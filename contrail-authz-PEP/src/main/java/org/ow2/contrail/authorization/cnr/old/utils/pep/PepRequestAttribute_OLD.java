...
public class PepRequestAttribute_OLD  implements XacmlAttribute {

	private String xacml_attribute_id, type, value, issuer;
	private UconCategory category;

	public PepRequestAttribute_OLD(String xacmlid, String type, String value, String issuer, UconCategory category) {
